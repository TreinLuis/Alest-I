...
public class LerArquivosCsv {
    ...
    private void iniciar() {// Complexidade de iniciar é N
        String filePath = "transacoes_00020.csv"; // Certifique-se de que o caminho do arquivo está correto
    ...
    private void imprimirMatrizVendas(int[][] matrizVendas) {//nˆ3
        ...
        String[] nomesFilias = {"Matriz", "Filial Sul", "Filial Norte", "Filial Nordeste"};
        ...
        for (int i = 0; i < matrizVendas.length; i++) {//n
            System.out.printf("%-17s", nomesFilias[i]); // Nome da filial
            for (int j = 0; j < matrizVendas[i].length; j++) {//nˆ2
    ...
    private void mesMenorVenda(int[][] matrizVendas) {
        ...
        System.out.println("Mês com menor venda: " + nomesMeses[mesMenorVenda] + " (Vendas: " + somaVendasPorMes[mesMenorVenda] + ")");
    }
